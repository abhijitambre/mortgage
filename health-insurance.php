...
<head>
	<title>page-health-insurance</title>
	<meta charset="UTF-8">
...
<body>
	<div class="wrapper">
		...
		<main class="page">
			<section class="page__main-block main-block health-insurance-bg main-block-business-loans">
				<div class="main-block__container">
					<div class="main-block__body">
						<h1 class="main-block__title">Compare Health Insurance <span>Today!</span></h1>
						<div class="main-block__wrapper wrapper-main">
							<div class="wrapper-main__text ">
								Get health insurance quotes in under 60 seconds, for FREE
			...
			<section class="page__box box">
				<div class="box__container">
					...
					<div id="group2" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Do you have private health insurance?</div>
						<div class="box__buttons__wrapper ">
					...
					<div id="group3" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What age group are you in?</div>
						<div class="box__buttons__wrapper wrapper-2">
							<button type="button" class="box__button" data-target="group4">I'm under 65</button>
							<button type="button" class="box__button" data-target="group4">I'm 65+</button>
						</div>
					</div>
