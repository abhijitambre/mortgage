...
<head>
	<title>page-car-insurance</title>
	<meta charset="UTF-8">
...
<body>
	<div class="wrapper">
		...
		<main class="page">
			<section class="page__main-block main-block car-insurance-bg main-block-business-loans">
				<div class="main-block__container">
					<div class="main-block__body">
						<h1 class="main-block__title">Compare Auto Insurance <span>Today!</span></h1>
						<div class="main-block__wrapper wrapper-main">
							<div class="wrapper-main__text ">
								Get auto insurance quotes in under 60 seconds, for FREE
				...
				<div class="box__container">
					...
					<div id="group2" class="box__buttons" style="display: none;">
						...
						<div class="box__buttons__wrapper wrapper-2">
							<button type="button" class="box__button" data-target="group3">Comprehensive</button>
							<button type="button" class="box__button" data-target="group3">Comprehensive Plus</button>
							<button type="button" class="box__button" data-target="group3">Third Party Property Damage</button>
							<button type="button" class="box__button" data-target="group3">Third Party Fire & Theft</button>
							<button type="button" class="box__button" data-target="group3">Veteran, Vintage and Classic</button>
						</div>
					</div>
					<div id="group3" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What vehicle do you want to insure?</div>
						<form action="#" class="form__box box-form">
							<div class="box-form__body">
								<input type="text" data-required placeholder="E.g 2022 Ford Raptor" class="input inp-p">
							</div>
							<button type="submit" class="box-form__button box__button" data-target="group4">Continue</button>
						</form>
					</div>
					<div id="group4" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Is the car New or Used?</div>
						<div class="box__buttons__wrapper ">
							<button type="button" class="box__button" data-target="group5">New</button>
							<button type="button" class="box__button" data-target="group5">Used</button>
						</div>
					</div>
					<div id="group5" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Is the car New or Used?</div>
						<div class="range-value" id="value-9"></div>
						<div class="price-slider" data-target="value-9"></div>
					...
					<div id="group6" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Where is the vehicle parked usually?</div>
						<div class="box__buttons__wrapper ">
							<button type="button" class="box__button" data-target="group7">Garage</button>
							<button type="button" class="box__button" data-target="group7">Carport or undercover</button>
							<button type="button" class="box__button" data-target="group7">Driveway or on the property</button>
							<button type="button" class="box__button" data-target="group7">On the street</button>
						</div>
					</div>
					<div id="group7" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Alright, we are personalising your report.<br>
