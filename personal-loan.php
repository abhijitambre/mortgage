...
<head>
	<title>page-personal-loan</title>
	<meta charset="UTF-8">
...
<body>
	<div class="wrapper">
		...
		<main class="page">
			<section class="page__main-block main-block personal-loan-bg main-block-business-loans">
				<div class="main-block__container">
					<div class="main-block__body">
						<h1 class="main-block__title">Compare Personal Finance <span>Today!</span></h1>
						<div class="main-block__wrapper wrapper-main">
							<div class="wrapper-main__text ">
								Access personal funds in as little as 24 hours with no paperwork!
							...
							<div class="business-loans-body">
								...
								<div class="business-loans-body__text">Multiple Non Bank Funding Options and 60+ lenders, all from Compare 1</div>
			...
			<section class="page__box box">
				<div class="box__container">
					...
					<div id="group1" class="box__buttons">
						<div class="box__subtitle">What is the purpose of the loan?</div>
						<div class="box__buttons__wrapper box-f box-f-w">
							<button type="button" class="box__button" data-target="group2">Debt Consolidation</button>
							<button type="button" class="box__button" data-target="group2">Home Renovations</button>
							<button type="button" class="box__button" data-target="group2">Vehicle</button>
							<button type="button" class="box__button" data-target="group2">Holiday</button>
							<button type="button" class="box__button" data-target="group2">Unexpected Bills</button>
							<button type="button" class="box__button" data-target="group2">Other</button>
						</div>
					</div>
					<div id="group2" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Are you looking for a Personal Loan?</div>
					...
					<div id="group3" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Are you a homeowner?</div>
						<div class="box__buttons__wrapper ">
							<button type="button" class="box__button" data-target="group4">Yes</button>
							<button type="button" class="box__button" data-target="group4">No</button>
						</div>
					</div>
					<div id="group4" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Do you have any other loans?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group5">Yes</button>
							<button type="button" class="box__button" data-target="group5">No</button>
						</div>
					</div>
					<div id="group5" class="box__buttons" style="display: none;">
						<div class="box__subtitle">How much do you need to borrow for your debt consolidation?</div>
						<div class="range-value" id="value-11"></div>
						<div class="price-slider" data-target="value-11"></div>
						<div class="box__buttons__wrapper box-f">
							<button type="button" class="box__button" data-target="group6">Forward</button>
						</div>
					</div>
					<div id="group6" class="box__buttons" style="display: none;">
						<div class="box__subtitle sub-m">You're looking good for your loan so far!</div>
						<div class="box__title-10">Which situation best describes you?</div>
						<div class="box__label">(We can service some VISA types)</div>
						<div class="box__buttons__wrapper box-f box-f-w">
							<button type="button" class="box__button" data-target="group7">Australian Citizen</button>
							<button type="button" class="box__button" data-target="group7">Permanent Resident</button>
							<button type="button" class="box__button" data-target="group7">VISA Holder</button>
						</div>
					</div>
					<div id="group7" class="box__buttons" style="display: none;">
						...
						<div class="box__buttons__wrapper wrapper-2">
							<button type="button" class="box__button" data-target="group8">Outstanding - No Defaults or Late Payments</button>
							<button type="button" class="box__button" data-target="group8">Good - 1 Paid Default, Some Late Payments</button>
							<button type="button" class="box__button" data-target="group8">Average - 1 Unpaid Default and Late Repayments</button>
							<button type="button" class="box__button" data-target="group8">Low - Multiple Unpaid Defaults and Outstanding Repayments</button>
						</div>
					</div>
					<div id="group8" class="box__buttons" style="display: none;">
						...
						<div class="box__buttons__wrapper wrapper-2">
							<button type="button" class="box__button" data-target="group9">Employment</button>
							<button type="button" class="box__button" data-target="group9">Self Employment</button>
							<button type="button" class="box__button" data-target="group9">Pension</button>
							<button type="button" class="box__button" data-target="group9">Unemployment Benefits (centrelink)</button>
							<button type="button" class="box__button" data-target="group9">Currently no income</button>
							<button type="button" class="box__button" data-target="group9">Other</button>
						</div>
					</div>
					<div id="group9" class="box__buttons" style="display: none;">
						<div class="box__subtitle sub-m">What is your current average monthly income?</div>
						<div class="box__label">(Before tax)</div>
						<div class="range-value" id="value-12"></div>
						<div class="price-slider" data-target="value-12"></div>
						<div class="box__buttons__wrapper box-f">
							<button type="button" class="box__button" data-target="group10">Forward</button>
						</div>
					</div>
					<div id="group10" class="box__buttons" style="display: none;">
						...
						<div class="box__buttons__wrapper ">
							<button type="button" class="box__button" data-target="group11">0 - 3 Months</button>
							<button type="button" class="box__button" data-target="group11">3 - 6 Months</button>
							<button type="button" class="box__button" data-target="group11">6 - 12 Months</button>
							<button type="button" class="box__button" data-target="group11">12+ Months</button>
						</div>
					</div>
					<div id="group11" class="box__buttons" style="display: none;">
						<div class="box__subtitle">How old are you?</div>
						<div class="box__buttons__wrapper box-f box-f-w">
							<button type="button" class="box__button" data-target="group12">0-17</button>
							<button type="button" class="box__button" data-target="group12">18-19</button>
							<button type="button" class="box__button" data-target="group12">20-29</button>
							<button type="button" class="box__button" data-target="group12">30-39</button>
							<button type="button" class="box__button" data-target="group12">40-49</button>
							<button type="button" class="box__button" data-target="group12">50+</button>
						</div>
					</div>
					<div id="group12" class="box__buttons" style="display: none;">
						<div class="box__subtitle sub-m">What is your home address?</div>
						<div class="box__label">Please start typing your address, then select from the dropdown to continue</div>
						<form action="#" class="form__box box-form">
							...
							<button type="submit" class="box-form__button box__button" data-target="group13">Continue</button>
						</form>
					</div>
					<div id="group13" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Great News!</div>
						<div class="box__label">Based on the information you have provided, YOU QUALIFY!</div>
						<form action="#" class="form__box box-form">
							<div class="box-form__body">
							...
							<button type="submit" class="box-form__button box__button" data-target="group14">Continue</button>
						</form>
					</div>
