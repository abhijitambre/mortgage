...
<head>
	<title>page-superannuation</title>
	<meta charset="UTF-8">
...
<body>
	<div class="wrapper">
		...
		<main class="page">
			<section class="page__main-block main-block superannuation-bg main-block-business-loans">
				<div class="main-block__container">
					<div class="main-block__body">
						<h1 class="main-block__title superannuation-title">Compare Your Superannuation <span>Today!</span></h1>
						<div class="main-block__wrapper wrapper-main">
							<div class="wrapper-main__text superannuation-text">
								Get a superannuation performance review for increased returns, for FREE
			...
			<section class="page__box box">
				<div class="box__container">
					...
					<div id="group1" class="box__buttons">
						<div class="box__subtitle">What is your age?</div>
						<div class="box__buttons__wrapper box-f box-f-w">
							<button type="button" class="box__button" data-target="group2">20-29</button>
							<button type="button" class="box__button" data-target="group2">30-39</button>
							<button type="button" class="box__button" data-target="group2">40-49</button>
							<button type="button" class="box__button" data-target="group2">50-59</button>
							<button type="button" class="box__button" data-target="group2">60-69</button>
							<button type="button" class="box__button" data-target="group2">70+</button>
						</div>
					</div>
					<div id="group2" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your current employment status?</div>
						<div class="box__buttons__wrapper wrapper-2">
							<button type="button" class="box__button" data-target="group3">Employed</button>
							<button type="button" class="box__button" data-target="group3">Self-Employed</button>
							<button type="button" class="box__button" data-target="group3">Centrelink</button>
							<button type="button" class="box__button" data-target="group3">Retired</button>
						</div>
					</div>
					<div id="group3" class="box__buttons" style="display: none;">
						<div class="box__subtitle">How many Super fund accounts do you have?</div>
						<div class="box__buttons__wrapper ">
							<button type="button" class="box__button" data-target="group4">1-3</button>
							<button type="button" class="box__button" data-target="group4">4-6</button>
							<button type="button" class="box__button" data-target="group4">7+</button>
							<button type="button" class="box__button" data-target="group4">Not Sure</button>
						</div>
					</div>
					<div id="group4" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Do you have lost Super that you need help to find?</div>
						<div class="box__buttons__wrapper box-f box-f-w">
					...
					<div id="group5" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Do you know what returns your Super is currently making?</div>
						<div class="box__buttons__wrapper ">
							<button type="button" class="box__button" data-target="group6">0 - 5%</button>
							<button type="button" class="box__button" data-target="group6">5% - 10%</button>
							<button type="button" class="box__button" data-target="group6">10%+</button>
							<button type="button" class="box__button" data-target="group6">Not Sure</button>
						</div>
					</div>
					<div id="group6" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your estimated<br>
							Super Balance?</div>
						<div class="range-value" id="value-10"></div>
						<div class="price-slider" data-target="value-10"></div>
