...
<body>
	<div class="wrapper">
		...
		<main class="page">
			<section class="page__main-block main-block vehicle-loan-bg  main-block-business-loans">
				<div class="main-block__container">
					<div class="main-block__body">
						<h1 class="main-block__title">Compare Auto Finance <span>Today!</span></h1>
						<div class="main-block__wrapper wrapper-main">
							<div class="wrapper-main__text">
								Access business funds in as little as 24 hours with no paperwork!
							...
							<div class="business-loans-body">
								...
								<div class="business-loans-body__text">Multiple Non Bank Funding Options and 40+ lenders, all from Compare 1</div>
			...
			<section class="page__box box">
				<div class="box__container">
					...
					<div id="group1" class="box__buttons">
						<div class="box__subtitle">What type of vehicle do you want?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group2">Car</button>
							<button type="button" class="box__button" data-target="group2">SUV</button>
							<button type="button" class="box__button" data-target="group2">Truck</button>
							<button type="button" class="box__button" data-target="group2">4WD</button>
						</div>
					</div>
					<div id="group2" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Is the car for private or commercial use?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group3">Private</button>
							<button type="button" class="box__button" data-target="group3">Commercial</button>
						</div>
					</div>
					<div id="group3" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Is the car New or Used?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group4">New</button>
							<button type="button" class="box__button" data-target="group4">Used</button>
						</div>
					</div>
					<div id="group4" class="box__buttons" style="display: none;">
						<div class="box__subtitle sub-m">What car are you looking for?</div>
						<div class="box__label">Put "I don't know" if you're not sure yet</div>
						<input type="text" data-required placeholder="Which vehicle are you looking to finance?" class="input inp-p">
					...
					<div id="group5" class="box__buttons" style="display: none;">
						<div class="box__subtitle">How much is the car you are looking for?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group6">$2,000 - $5,000</button>
							<button type="button" class="box__button" data-target="group6">$5,000 - $10,000</button>
							<button type="button" class="box__button" data-target="group6">$10,000 - $20,000</button>
							<button type="button" class="box__button" data-target="group6">$20,000 - $30,000</button>
							<button type="button" class="box__button" data-target="group6">$30,000 - $50,000</button>
							<button type="button" class="box__button" data-target="group6">Over $50,000</button>
						</div>
					</div>
					<div id="group6" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Are you looking for an Auto Loan?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group7">Yes</button>
							<button type="button" class="box__button" data-target="group7">No</button>
						</div>
					</div>
					<div id="group7" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Are you looking for a loan for your business?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group8">Yes</button>
							<button type="button" class="box__button" data-target="group8">No</button>
						</div>
					</div>
					<div id="group8" class="box__buttons" style="display: none;">
						<div class="box__subtitle">How much do you need to borrow?</div>
						<div class="range-value" id="value-3"></div>
						<div class="price-slider" data-target="value-3"></div>
						<div class="box__buttons__wrapper box-f">
							<button type="button" class="box__button" data-target="group9"> Forward</button>
						</div>
					</div>
					<div id="group9" class="box__buttons" style="display: none;">
						<div class="box__subtitle">How are you currently generating income?</div>
						<div class="box__label">(Centrelink and Pension is fine)</div>
						<div class="box__buttons__wrapper box-f box-f-w">
							<button type="button" class="box__button" data-target="group10">Employment</button>
							<button type="button" class="box__button" data-target="group10">Self Employment</button>
							<button type="button" class="box__button" data-target="group10">Pension</button>
							<button type="button" class="box__button" data-target="group10">Unemployment Benefits</button>
							<button type="button" class="box__button" data-target="group10">Other</button>
						</div>
					</div>
					<div id="group10" class="box__buttons" style="display: none;">
						<div class="box__subtitle sub-m">You're looking good for your new car so far!</div>
						<div class="box__title-10">Which situation best describes you?</div>
						<div class="box__label">(We can service some VISA types)</div>
						<div class="box__buttons__wrapper box-f ">
							<button type="button" class="box__button" data-target="group11">Australian Citizen</button>
							<button type="button" class="box__button" data-target="group11">Permanent Resident</button>
							<button type="button" class="box__button" data-target="group11">VISA Holder</button>
						</div>
					</div>
					<div id="group11" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your credit history?</div>
						<div class="box__label">This doesn't affect your credit*</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group12">Outstanding - No Defaults or Late Payments</button>
							<button type="button" class="box__button" data-target="group12">Good - 1 Paid Default, Some Late Payments</button>
							<button type="button" class="box__button" data-target="group12">Average - 1 Unpaid Default and Late Repayments</button>
							<button type="button" class="box__button" data-target="group12">Low - Multiple Unpaid Defaults and Outstanding Repayments</button>
						</div>
					</div>
					<div id="group12" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your current average monthly income?</div>
						<div class="box__label">(Before tax)</div>
						<div class="range-value" id="value-4"></div>
						<div class="price-slider" data-target="value-4"></div>
						<div class="box__buttons__wrapper box-f">
							<button type="button" class="box__button" data-target="group13">Forward</button>
						</div>
					</div>
					<div id="group13" class="box__buttons" style="display: none;">
						<div class="box__subtitle">How long have you been earning this income?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group14">0 - 3 Months</button>
							<button type="button" class="box__button" data-target="group14">3 - 6 Months</button>
							<button type="button" class="box__button" data-target="group14">6 - 12 Months</button>
							<button type="button" class="box__button" data-target="group14">12+ Months</button>
						</div>
					</div>
					<div id="group14" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your home address?</div>
						<form action="#" class="form__box box-form">
							...
							<button type="submit" class="box-form__button box__button" data-target="group15">Continue</button>
						</form>
					</div>
					<div id="group15" class="box__buttons" style="display: none;">
						<div class="box__subtitle sub-m">Great News!</div>
						<div class="box__title-10 fz-small">Based on the information you have provided, YOU ARE ELIGIBLE!
							From here, you can compare offers to find the best Auto loans available to you.</div>
						<div class="box__label">Please provide your details below</div>
						<form action="#" class="form__box box-form">
							<div class="box-form__body">
							...
							<button type="submit" class="box-form__button box__button" data-target="group16">Continue</button>
						</form>
					</div>
					<div id="group16" class="box__buttons" style="display: none;">
