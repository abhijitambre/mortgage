...
<head>
	<title>page-business-loans</title>
	<meta charset="UTF-8">
...
<body>
	<div class="wrapper">
		...
		<main class="page">
			<section class="page__main-block main-block main-block-business-loans">
				<div class="main-block__container">
					<div class="main-block__body">
						<h1 class="main-block__title">Compare Business Finance <span>Today!</span></h1>
			...
			<section class="page__box box">
				<div class="box__container">
					...
					<div id="group2" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Do you have an ABN or ACN?</div>
						<div class="box__buttons__wrapper">
					...
					<div id="group3" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Estimated loan amount? ($AUD)</div>
						<div class="range-value" id="value-1"></div>
						<div class="price-slider" data-target="value-1"></div>
					...
					<div id="group5" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your ABN trading time? (In Months)</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group6">0-5</button>
							<button type="button" class="box__button" data-target="group6">6</button>
							<button type="button" class="box__button" data-target="group6">12</button>
							<button type="button" class="box__button" data-target="group6">24</button>
							<button type="button" class="box__button" data-target="group6">36</button>
							<button type="button" class="box__button" data-target="group6">49</button>
						</div>
					</div>
					<div id="group6" class="box__buttons" style="display: none;">
						<div class="box__subtitle sub-m">What is your credit history?</div>
						<div class="box__label">This doesn't effect your credit score*</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group7">Great</button>
							<button type="button" class="box__button" data-target="group7">Good</button>
							<button type="button" class="box__button" data-target="group7">Avarage</button>
							<button type="button" class="box__button" data-target="group7">I don't know</button>
						</div>
					</div>
					...
					<div id="group8" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Are you looking for a loan for your business?</div>
						<div class="range-value" id="value-2"></div>
						<div class="price-slider" data-target="value-2"></div>
						<div class="box__buttons__wrapper box-f">
					...
					<div id="group9" class="box__buttons" style="display: none;">
						...
						<div class="box__buttons__wrapper box-f box-f-w">
							<button type="button" class="box__button" data-target="group10">NSW</button>
							<button type="button" class="box__button" data-target="group10">VIC</button>
							<button type="button" class="box__button" data-target="group10">QLD</button>
							<button type="button" class="box__button" data-target="group10">ACT</button>
							<button type="button" class="box__button" data-target="group10">SA</button>
							<button type="button" class="box__button" data-target="group10">WA</button>
							<button type="button" class="box__button" data-target="group10">NT</button>
							<button type="button" class="box__button" data-target="group10">TAS</button>
						</div>
					</div>
					<div id="group10" class="box__buttons" style="display: none;">
						...
						<form action="#" class="form__box box-form">
							<div class="box-form__body">
								<input type="text" data-required placeholder="First Name" class="input inp-p">
								<input type="text" data-required placeholder="Last Name" class="input inp-p">
								<input type="text" data-required placeholder="Business Name" class="input inp-p">
							</div>
					...
					<div id="group11" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Please enter your email</div>
						<form action="#" class="form__box box-form">
							<div class="box-form__body">
