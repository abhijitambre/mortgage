...
<body>
	<div class="wrapper">
		...
		<main class="page">
			<section class="page__main-block main-block mortgage-bg main-block-business-loans">
				<div class="main-block__container">
					<div class="main-block__body">
						<h1 class="main-block__title">Compare Your Mortgage <span>Today!</span></h1>
						<div class="main-block__wrapper wrapper-main">
							<div class="wrapper-main__text ">
								See how much you can save by comparing refinance quotes!
								<picture><source srcset="img/business-loan/swoosh.webp" type="image/webp"><img class="image-business-loans image-mortgage" src="img/business-loan/swoosh.png" alt="green-swoosh"></picture>
							</div>
							<div class="business-loans-body">
								...
								<div class="business-loans-body__text">Multiple Non Bank Funding Options and 80+ lenders, all from Compare 1</div>
			...
			<section class="page__box box">
				<div class="box__container">
					...
					<div id="group1" class="box__buttons">
						<div class="box__subtitle">How can we help you?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group2">I would like to refinance</button>
							<button type="button" class="box__button" data-target="group2">I would like to buy a home</button>
						</div>
					</div>
					<div id="group2" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Why would you like to refinance?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group3">Reduce Mortgage Repayments</button>
							<button type="button" class="box__button" data-target="group3">Consolidate Debt</button>
							<button type="button" class="box__button" data-target="group3">Reduce Loan Term</button>
							<button type="button" class="box__button" data-target="group3">Get Cash Out</button>
							<button type="button" class="box__button" data-target="group3">Deposit For Investment Property</button>
							<button type="button" class="box__button" data-target="group3">Other</button>
						</div>
					</div>
					<div id="group3" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What rate do you currently have?</div>
						<div class="box__label">estimate is fine!</div>
						<div class="range-value" id="value-5"></div>
						<div class="price-slider" data-target="value-5"></div>
						<div class="box__buttons__wrapper box-f">
							<button type="button" class="box__button" data-target="group4"> Forward</button>
						</div>
					</div>
					<div id="group4" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your current loan type?</div>
						<div class="box__buttons__wrapper mb">
							<button type="button" class="box__button" data-target="group5">Fixed</button>
							<button type="button" class="box__button" data-target="group5">Variable</button>
							<button type="button" class="box__button" data-target="group5">Fixed & Variable</button>
							<button type="button" class="box__button" data-target="group5">Not Sure</button>
						</div>
					</div>
					<div id="group5" class="box__buttons" style="display: none;">
						<div class="box__subtitle">How much do you have left on your mortgage?</div>
						<div class="box__label">An estimate is okay</div>
						<div class="range-value" id="value-6"></div>
						<div class="price-slider" data-target="value-6"></div>
						<div class="box__buttons__wrapper box-f">
					...
					<div id="group6" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is the value of the property?</div>
						<div class="box__label">An estimate is fine</div>
						<div class="range-value" id="value-7"></div>
						<div class="price-slider" data-target="value-7"></div>
						<div class="box__buttons__wrapper box-f">
							<button type="button" class="box__button" data-target="group7"> Forward</button>
						</div>
					</div>
					<div id="group7" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your employment status?</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group8">Employed</button>
							<button type="button" class="box__button" data-target="group8">Self Employed</button>
							<button type="button" class="box__button" data-target="group8">Retired</button>
							<button type="button" class="box__button" data-target="group8">Unemployed</button>
							<button type="button" class="box__button" data-target="group8">Centrelink</button>
							<button type="button" class="box__button" data-target="group8">Other</button>
						</div>
					</div>
					<div id="group8" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your credit history?</div>
						<div class="box__label">This doesn't effect your credit score</div>
						<div class="box__buttons__wrapper">
							<button type="button" class="box__button" data-target="group9">Great</button>
							<button type="button" class="box__button" data-target="group9">Good</button>
							<button type="button" class="box__button" data-target="group9">Average</button>
							<button type="button" class="box__button" data-target="group9">Bad</button>
							<button type="button" class="box__button" data-target="group9">I don't know</button>
						</div>
					</div>
					<div id="group9" class="box__buttons" style="display: none;">
						<div class="box__subtitle">What is your combined <br>monthly household income?</div>
						<div class="box__label">An estimate is fine</div>
						<div class="range-value" id="value-8"></div>
						<div class="price-slider" data-target="value-8"></div>
						<div class="box__buttons__wrapper box-f">
					...
					<div id="group10" class="box__buttons" style="display: none;">
						...
						<form action="#" class="form__box box-form">
							...
							<button type="submit" class="box-form__button box__button" data-target="group11">Continue</button>
						</form>
					</div>
					<div id="group11" class="box__buttons" style="display: none;">
						<div class="box__subtitle sub-m">Congratulations! You Qualify To Reduce Your Repayment!</div>
						<div class="box__label">Please enter your name below</div>
						<form action="#" class="form__box box-form">
							<div class="box-form__body">
							...
							<button type="submit" class="box-form__button box__button" data-target="group12">Continue</button>
						</form>
					</div>
					<div id="group12" class="box__buttons" style="display: none;">
						<div class="box__subtitle">Almost Done</div>
						<div class="box__label">Please Fill Out The Information Below So You Can Get Your Refinancing Options!</div>
